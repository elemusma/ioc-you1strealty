...
function you1strealty_stylesheets() {
...
wp_enqueue_style('bickham','//use.typekit.net/xvg1tbq.css');

}
add_action('wp_enqueue_scripts', 'you1strealty_stylesheets');
// for footer
function you1strealty_stylesheets_footer() {
...
add_action('get_footer', 'you1strealty_stylesheets_footer');
...
add_action('after_setup_theme', 'you1strealty_menus');
